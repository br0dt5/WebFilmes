...
namespace WebFilmes.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseYear,Genre,Director,Synopsis")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseYear,Genre,Director,Synopsis")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
